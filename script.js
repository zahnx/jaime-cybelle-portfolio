...
// 👌👌👌 Showing the back to top button when scrolled

document.addEventListener('DOMContentLoaded', function () {
  const navbar = document.querySelector('.go-top-btn');

  function showGoTopBtn() {
    if (window.scrollY > 50) {
      navbar.classList.remove('gotop-hidden');
    } else {
      navbar.classList.add('gotop-hidden');
    }
  }
